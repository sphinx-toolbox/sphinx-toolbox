...
# this package
from sphinx_toolbox.more_autodoc.utils import parse_parameters
...
docstring = dedent(
	...
	:param list content: A list of strings, the directive content for customization (from the ``role`` directive).
		To be interpreted by the function.
